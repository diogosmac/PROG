...
void Player::statsPlayer() {
	...
	if (numbHints == 1){
		outputSentence << name << " played for a total of " << timePlayed << " seconds and used 1 extra hint." << "\n";
	}
	else{
		outputSentence << name << " played for a total of " << timePlayed << " seconds and used " << numbHints << " extra hints." << "\n";
	}
